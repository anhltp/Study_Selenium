...
public class Test_Login {
	...
	/*
	 * Function for each testcase
	 */

	/*
	 * 1. Function Login with wrong password
	 */
	static void Login_WrongPass() throws InterruptedException{
	...
	/*
	 * 2. Function Login with invalid Email	
	 */
	static void Login_InvalidEmail() throws InterruptedException{
	...
	/*
	 * 3. Function Login with valid information	
	 */
	static void LoginSucessfully() throws InterruptedException{
